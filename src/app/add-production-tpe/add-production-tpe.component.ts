...
@Component({
  selector: 'app-add-production-tpe',
  templateUrl: './add-production-tpe.component.html',
  styleUrls: ['./add-production-tpe.component.less']
})
export class AddProductionTpeComponent implements OnInit {
  
    public form: FormGroup; // our form model
    
    constructor(private commService: CommService,
      private dialogRef: MatDialogRef<AddProductionTpeComponent>,
  ...
  private productQtyArry:{name:string,qtyUsed:number,qtyWaste:number}[]=[];
    ...
    save() {
      ...
      this.checkAndAdd('_sebs7550',"SEBS 7550");
      this.checkAndAdd('_sebs7551',"SEBS 7551");
      this.checkAndAdd('_ppFirst',"P.P. First");
      this.checkAndAdd('_ppSecond',"P.P. Second");
      this.checkAndAdd('_calcium',"Calcium");
      this.checkAndAdd('_oil',"Oil");
      this.checkAndAdd('_antioxident',"Antioxident");
      this.checkAndAdd('_vistamax',"Vistamax");
      this.checkAndAdd('_sbs401', "SBS 401");
